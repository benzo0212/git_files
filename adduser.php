<?php
    ...
    if ($fail == ""){
        echo "</head><body>Form data validated:
            $forename, $surname, $username, $password, $age, $email.</body></html>";

    //Enter the posted fields into the database preferably using hash encryption for the password.
            ...
            function validate(form){
                ...
                function validateUsername(field){
                    if(field == "") return "No Username was entered. \n"
                        ...
                        return "Username must at least have 5 characters. \n"
                ...
                function validateAge(field){
                    if (field == "" || isNaN(field)) return "No age was entered.\n"
                        ...
                        return "Age must be betweeen 18 and 110"
                    return ""
                }
...
_END
    ...
    function validate_email($field){
        if ($field == 0) return "No Email was entered<br>";
        else if (!((strpos($field, ".") > 0) &&
                (strpos($field, "@") > 0)) ||
                preg_match("/[^a-zA-Z0-9.@_-]/", $field))
            return "The Email aaddress is invalid<br>";
        return "";
    }
